    ...
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public com.sakila.data.Country getCountryById(Short id) {
        List<com.sakila.data.Country> rtn = ((List<com.sakila.data.Country> ) dsMgr.invoke(taskMgr.getQueryTask(), (SakilaConstants.getCountryByIdQueryName), id));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
